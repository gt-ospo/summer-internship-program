...
We are optimistic that students and mentors will both work effectively together during the VSIP, but we would like to remind both mentors and mentees of the following suggested guidelines. Please report any issues you encounter to the OSPO directors via our email form at https://ospo.cc.gatech.edu/contact/ or to Jeff or Fang via the VSIP Discord. The directors reserve the right to intervene if these guidelines are not followed and in rare cases, to request that a participant leave the program if they are not able to meet these expectations. 
...
- Work with OSPO directors and GT and external collaborators to resolve any problems encountered
...
- **Be respectful of your mentor's time!**
    ...
    - Remember that it's perfectly ok to be behind on a task or struggle with new concepts, as long as you are communicating well with your mentors.
- Ask questions / ask for help!
    - The goal of this program is to help you learn effective ways to contribute to open source projects, so we don't expect you to know everything already!
