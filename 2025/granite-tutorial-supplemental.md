...
## Part 1: Starting an Open OnDemand instance
...
## Part 2: Setting Up Your PACE Virtual Environment
After some time, the node will be created - next you'll need to set up a "clean" venv or virtual environment to run the workshop notebooks. Access the terminal by navigating to `My Interactive Session`, then clicking your node's unique session ID, and finally clicking `Open in Terminal`.

![SS2](https://github.com/user-attachments/assets/03e38ace-40cf-42e3-96fb-3f5758d6ed80)

![SS3](https://github.com/user-attachments/assets/01630625-e893-42ba-be42-47e4e88913cb)
...
## Part 3: Clone The Granite Workshop Repo
